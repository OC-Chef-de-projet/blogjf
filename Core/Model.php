...
abstract class Model extends \stdClass
{
    ...
    private function connect()
    {
        if (is_null($this->db)) {
            ...
            $db = new \PDO(
                'mysql:dbname='.Config::getInstance()->db('database').';'.
    ...
    /**
     * Requête pour effacement
     *
     * @param int $pkey clé primaire
     *
     * @return bool
     */
     ...
     *
     * @param array $options Option de recherche
     *
     * @return int
     */
     ...
     * @param array  $args Arguments pour le prépare
     *
     * @return bool
     */
     ...
     *
     * @param array $data Donénes à enregistrer
     *
     * @return object
     */
